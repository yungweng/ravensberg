...
export function PrinzipCard({ prinzip }: PrinzipCardProps) {
  return (
    <div className="rounded-lg overflow-hidden bg-background transition-shadow duration-300 hover:shadow-lg h-full">
